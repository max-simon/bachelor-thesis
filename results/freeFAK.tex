...
\\
The contact map for configurations of spot 1 shows similar features as obtained for spot 2. However, in area 2 less spots occur (see \autoref{free:contact}) which is reasonable since the C-lobe is tilted against the FERM domain. % still not clear, why in mutant of Y180 nicht diese pose eingenommen wird.
%
%
\begin{figure}
	\centering
