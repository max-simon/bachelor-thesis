...
%
%
The contact map of the interface between the FERM domain and the kinase for frames of spot 2 is shown in \autoref{free:contact}. Two contact areas can be identified. The first one (area 1) is located between F1 and the N-lobe/activation loop. It shows especially contacts between \acid{Y}{576} and \acid{Y}{577} and residues of the FERM domain. The minimal distance in this area, occurring between residue \acid{H}{41} and \acid{Y}{576}, is $0.45\,\si{\nano\metre}$ with an RMSF value of $0.03\,\si{\nano\metre}$. This area reflects the burying of the activity regulating residues in closed state.\\
...
\begin{figure}
	\subcaptionbox{\label{free:3d_spot1}}[0.32\textwidth]{
		\includegraphics[height=4cm]{figures/results/spot1}
	}\hfill%
	\subcaptionbox{\label{free:3d_spot2}}[0.32\textwidth]{
		\includegraphics[height=4cm]{figures/results/spot2}
	}\hfill%
	\subcaptionbox{\label{free:3d_spot_top}}[0.32\textwidth]{
		\includegraphics[height=4cm]{figures/results/spot2_top}
	}
	\nicecaption{3D structure of FAK in the different states}{The 3D structures show the FERM domain (blue), the kinase (red) and the linker (black, transparent). The autophosphorylation site \acid{Y}{397} (green) is plunged into interface and hidden by the linker (\subref{free:3d_spot1}): configuration of spot 1. The kinase is tilted against the domain. (\subref{free:3d_spot2} and \subref{free:3d_spot_top}): configuration of spot 2. Both domains are in line.}
\end{figure}
%
%
%
