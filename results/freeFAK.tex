...
\begin{figure}
	...
	\nicecaption{Domain distances and contact area of FAK-SOL}{(\subref{free:f2clf1nl}): two dimensional hexagonal binning plot of $d_\text{F1-N}$ and $d_\text{F2-C}$ which implies a two state system. The tilting of the kinase (red) against the FERM domain (blue) is sketched beside. Here, the star marks the position of the basic patch. (\subref{free:ca}): Distribution of the CA value for the two obtained spots. The mean differs ca. $2\%$.}
