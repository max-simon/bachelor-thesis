...
\begin{figure}
	...
	\nicecaption{Structure of FAK}{The FERM domain consiting of F1 (green), F2 (iceblue) and F3 (blue) connected via the linker to the kinase consisting of N-lobe (violet), activation loop (black) and C-lobe (red). The basic patch (F2), \acid{Y}{397} (linker) and \acid{Y}{567}, \acid{Y}{577} (activation loop) are highlighted.}
	\label{intro:fak}
\end{figure}
%
%
