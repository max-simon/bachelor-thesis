...
\begin{figure}
	...
	\captionof{figure}{Focal adhesion kinase with the FERM domain (left) and the kinase (right). The basic patch inside F2 (light blue) and \acid{Y}{397} bound to F1 (light green) as well as \acid{Y}{576} and \acid{Y}{577} in the kinase are highlighted.}
	\label{intro:fak}
\end{figure}
%
%
