...
%
\begin{figure}
	\subcaptionbox{Distributions of $\beta$ obtained by \textcite{sara}.\label{motiv:saras_curves}}[0.49\textwidth]{
		\includegraphics[height=5cm]{figures/introduction/sara_angles}
	}\hfill%
	\subcaptionbox{Illustration of the applied force.\label{motiv:force_illustr}}[0.49\textwidth]{
