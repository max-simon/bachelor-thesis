Because the measurable time- and length scale of biological experiments are usually larger than those of the system, the dynamics in the system can only be measured indirectly. To get a more precise insight into the concrete processes, Molecular dynamics simulation (MD) are a suitable tool.\\
...
\begin{figure}
	...
	\nicecaption{Interactions in MD}{(\subref{md:fig_bonds}): illustration of bonded interactions. (\subref{md:fig_pot}): schematic course of contributing potentials}
	\label{md:figs}
\end{figure}
%
%
...
\begin{figure}
	...
	\nicecaption{\martini{} bead mapping}{\martini{} structure of \pip{}. Four heavy atoms are mapped to one \martini{} bead.}
